...
[![Codecov test coverage](https://codecov.io/gh/jmbarbone/facts/graph/badge.svg)](https://app.codecov.io/gh/jmbarbone/facts)
<!-- badges: end -->
...
One benefit of `factor()` is that you can recode on the fly.
...
As such, `recode()` is included, and can be used prior to `facts()` or after.
